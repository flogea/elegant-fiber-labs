    ...
    <form>
      <div className="container">
        ...
        <div>
          ...
          <div className="main-text">
            8 Источник питания установите на 1 В. Повторите измерения модуляционной характеристики
            (2) (см. п. 6)
          </div>
        ...
        <div>
          ...
          <div className="main-text">
            9 Ввести в оптический тракт входной поляризатор. Для этого необходимо, вращая ходовой
            винт подвижки, установить поляризатор таким образом, чтобы луч лазера проходил через
            центр поляризатора. Поворачивая вращающуюся оправку поляризатора, совместить метку на
            оправке с меткой 1 на обойме.
          </div>
          <div className="main-text">
