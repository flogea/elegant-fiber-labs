  ...
  return (
    <>
      <div>
        ...
        <div className="row">
          <div className="col">
            ...
            <input type="text" className="input-table" name="1" onChange={handleChangeTable12_2} />
          </div>
        </div>
      ...
      <div>
        ...
        <div className="main-text">23 Зафиксируйте значение a, при котором наибольший I1.</div>
        <div className="row">
          <div className="col">
      ...
      <div>
        ...
        <div className="main-text">
          24 Установите a, равное a оптимальное вращением нижнего винта держателя, на котором он
          закреплен.
        </div>
        <div className="main-text">
